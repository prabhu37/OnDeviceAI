package com.google.mediapipe.examples.llminference.docs
...
import com.google.mediapipe.examples.llminference.data.Document
import com.google.mediapipe.examples.llminference.domain.readers.Readers
import com.google.mediapipe.examples.llminference.ui.components.AppAlertDialog
import com.google.mediapipe.examples.llminference.ui.components.createAlertDialog
...
fun DocsScreen(onBackClick: (() -> Unit)) {
   LLMInferenceTheme  {
        Scaffold(
            ...
            val docsViewModel: DocsViewModel = viewModel(factory = DocsViewModel.getFactory(context))
